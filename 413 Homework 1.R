...
# How do I take a timeseries object and create a dataframe
# inlcuding years, months from the original timeseries?
# Not working.....
log.fancy.DF <- data.frame(log.fancy)
test.dummy <- ifelse(log.fancy=="Mar", 1,0)
